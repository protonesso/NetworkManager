...
nm_setting_ethtool_clear_features (NMSettingEthtool *setting)
{
	...
	_nm_setting_option_clear_by_name (NM_SETTING (setting), nm_ethtool_optname_is_feature);
}
...
nm_setting_ethtool_clear_coalesces (NMSettingEthtool *setting)
{
	...
	_nm_setting_option_clear_by_name (NM_SETTING (setting), nm_ethtool_optname_is_coalesce);
}
