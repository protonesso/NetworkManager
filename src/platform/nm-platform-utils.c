                      ...
                      NMEthtoolCoalesceState *coalesce)
{
	...
	*coalesce = (NMEthtoolCoalesceState) {
	    .s = {
	        [NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_RX_USECS)]          = eth_data.rx_coalesce_usecs,
	        [NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_RX_FRAMES)]         = eth_data.rx_max_coalesced_frames,
	        [NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_RX_USECS_IRQ)]      = eth_data.rx_coalesce_usecs_irq,
	        [NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_RX_FRAMES_IRQ)]     = eth_data.rx_max_coalesced_frames_irq,
	        [NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_TX_USECS)]          = eth_data.tx_coalesce_usecs,
	        [NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_TX_FRAMES)]         = eth_data.tx_max_coalesced_frames,
	        [NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_TX_USECS_IRQ)]      = eth_data.tx_coalesce_usecs_irq,
	        [NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_TX_FRAMES_IRQ)]     = eth_data.tx_max_coalesced_frames_irq,
	        [NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_STATS_BLOCK_USECS)] = eth_data.stats_block_coalesce_usecs,
	        [NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_ADAPTIVE_RX)]       = eth_data.use_adaptive_rx_coalesce,
	        [NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_ADAPTIVE_TX)]       = eth_data.use_adaptive_tx_coalesce,
	        [NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_PKT_RATE_LOW)]      = eth_data.pkt_rate_low,
	        [NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_RX_USECS_LOW)]      = eth_data.rx_coalesce_usecs_low,
	        [NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_RX_FRAMES_LOW)]     = eth_data.rx_max_coalesced_frames_low,
	        [NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_TX_USECS_LOW)]      = eth_data.tx_coalesce_usecs_low,
	        [NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_TX_FRAMES_LOW)]     = eth_data.tx_max_coalesced_frames_low,
	        [NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_PKT_RATE_HIGH)]     = eth_data.pkt_rate_high,
	        [NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_RX_USECS_HIGH)]     = eth_data.rx_coalesce_usecs_high,
	        [NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_RX_FRAMES_HIGH)]    = eth_data.rx_max_coalesced_frames_high,
	        [NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_TX_USECS_HIGH)]     = eth_data.tx_coalesce_usecs_high,
	        [NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_TX_FRAMES_HIGH)]    = eth_data.tx_max_coalesced_frames_high,
	        [NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_SAMPLE_INTERVAL)]   = eth_data.rate_sample_interval,
	    }
	};
	return TRUE;
}
                      ...
                      const NMEthtoolCoalesceState *coalesce)
{
	...
	eth_data = (struct ethtool_coalesce) {
		...
		.rx_coalesce_usecs            = coalesce->s[NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_RX_USECS)],
		.rx_max_coalesced_frames      = coalesce->s[NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_RX_FRAMES)],
		.rx_coalesce_usecs_irq        = coalesce->s[NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_RX_USECS_IRQ)],
		.rx_max_coalesced_frames_irq  = coalesce->s[NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_RX_FRAMES_IRQ)],
		.tx_coalesce_usecs            = coalesce->s[NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_TX_USECS)],
		.tx_max_coalesced_frames      = coalesce->s[NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_TX_FRAMES)],
		.tx_coalesce_usecs_irq        = coalesce->s[NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_TX_USECS_IRQ)],
		.tx_max_coalesced_frames_irq  = coalesce->s[NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_TX_FRAMES_IRQ)],
		.stats_block_coalesce_usecs   = coalesce->s[NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_STATS_BLOCK_USECS)],
		.use_adaptive_rx_coalesce     = coalesce->s[NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_ADAPTIVE_RX)],
		.use_adaptive_tx_coalesce     = coalesce->s[NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_ADAPTIVE_TX)],
		.pkt_rate_low                 = coalesce->s[NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_PKT_RATE_LOW)],
		.rx_coalesce_usecs_low        = coalesce->s[NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_RX_USECS_LOW)],
		.rx_max_coalesced_frames_low  = coalesce->s[NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_RX_FRAMES_LOW)],
		.tx_coalesce_usecs_low        = coalesce->s[NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_TX_USECS_LOW)],
		.tx_max_coalesced_frames_low  = coalesce->s[NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_TX_FRAMES_LOW)],
		.pkt_rate_high                = coalesce->s[NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_PKT_RATE_HIGH)],
		.rx_coalesce_usecs_high       = coalesce->s[NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_RX_USECS_HIGH)],
		.rx_max_coalesced_frames_high = coalesce->s[NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_RX_FRAMES_HIGH)],
		.tx_coalesce_usecs_high       = coalesce->s[NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_TX_USECS_HIGH)],
		.tx_max_coalesced_frames_high = coalesce->s[NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_TX_FRAMES_HIGH)],
		.rate_sample_interval         = coalesce->s[NM_ETHTOOL_COALESCE_STATE_IDX (NM_ETHTOOL_ID_COALESCE_SAMPLE_INTERVAL)],
	};
